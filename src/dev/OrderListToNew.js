  ...
  const asdasdasdasd = () => {
    ...
    [].concat
      .apply(
        [],
        orders
          ?.filter(or => or.data.customer === "95mama@mail2000.com.tw")
        ...
        async li =>
          await db
            ...
            .set({
              ...
              addName: "default Address",
              category: "cd",
              country: accounts.find(doc => doc.id === "95mama@mail2000.com.tw")
                .data.country,
              shippingType: "dhl",
              userId: "95mama@mail2000.com.tw",
              userUid: "95mama@mail2000.com.tw",
            })
      );
    // });
